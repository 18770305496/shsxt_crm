...
<div region="west" style="width: 200px" title="导航菜单" split="true">
    ...
    <#if permissions??>
        ...
        <div title="客户管理" data-options="iconCls:'icon-khgl'" style="padding:10px;">
            ...
            <a href="javascript:openTab('公司名称管理','customerCompany/index','icon-khlsgl')" class="easyui-linkbutton"
            ...
            <a href="javascript:openTab('访问日志','sysLog/index','icon-khlsgl')" class="easyui-linkbutton"
               data-options="plain:true,iconCls:'icon-khlsgl'" style="width: 150px;">访问日志</a>
        </div>
